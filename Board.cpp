...
void Board::playerTwoMove(int &currCell) {
    int play;
...
void Board::checkTwoMove(int &currCell, int &playerTurn) {
...
void Board::checkOneMove(int &currCell, int &playerTurn) {
...
void Board::playerOneMove(int &currCell) {
    int play;
...
void Board::accumulateFinalPoints() {
